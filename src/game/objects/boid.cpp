...
Boid::Boid(v3 translation) {
    ...
    this->addTriangle(this->rightWingId, v2i, trli);
    this->addTriangle(this->rightWingId, v4i, trhi);
    this->addTriangle(this->rightWingId, v2i, v4i);
    this->addTriangle(this->rightWingId, trli, trhi);
